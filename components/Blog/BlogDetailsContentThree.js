                ...
                <div className="blog-details-desc">
                    <div className="article-content">
                        ...
                        <div className="text-center">
                            <img src="/img/blog/rnd-blog-3.png" alt="image" />
                        </div>
                        <p>
                            <br />
                        ...
                        <div className="article-author">
                            ...
                            <div className="author-profile">
                                <div className="author-profile-title">
                                    <img src="/img/blog/radhika.png" className="shadow-sm" alt="image" />
                                    <h4>Radhika Vemura</h4>
                                    <span className="d-block">Chief Technology officer</span>
                                    <p>
