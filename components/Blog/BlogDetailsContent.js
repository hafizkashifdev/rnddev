                            ...
                            <div className="article-footer">
                                ...
                                <div className="article-share">
                                    <ul className="social">
                                        ...
                                        <li>
                                            <Link href="#">
                                                <a className="twitter" target="_blank"><i className='bx bxl-twitter'></i></a>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="#">
                                                <a className="linkedin" target="_blank"><i className='bx bxl-linkedin'></i></a>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="#">
                                                <a className="instagram" target="_blank"><i className='bx bxl-instagram'></i></a>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
