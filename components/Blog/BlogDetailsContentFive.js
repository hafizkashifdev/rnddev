                ...
                <div className="blog-details-desc">
                    <div className="article-content">
                        ...
                        <div className="text-center">
                            <img src="/img/blog/rnd-blog-5.png" alt="image" className="w-75" />
                        </div>
                        ...
                        <div className="article-author">
                            ...
                            <div className="author-profile">
                                <div className="author-profile-title">
                                    <img src="/img/blog/mubashir.png" className="shadow-sm" alt="image" />
                                    <h4>Mubashir Habib</h4>
                                    <span className="d-block">Head of Operations</span>
                                    <p>
