...
import { mondayRoiLambdaurl,airtableRoiLambdaurl,twillioLambdaurl, emailhtml, emailtitle,  AirTableBase, RYIBoardId, RYItable } from "../../constants/constant";
...
const RegisterYourInterestsForm = () => {
    ...
    const registerUser = async event => {
        ...
        axios.all([
            axios.post(`${mondayRoiLambdaurl}/ROI-SaleSiteRoute-monday`, {
            ...
            axios.post(`${airtableRoiLambdaurl}/airtableROI`, {
                Title: event.target.title.value,
                FirstName: event.target.firstname.value,
                LastName: event.target.lastname.value,
                Company: event.target.company.value,
    ...
    `}</style>
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                     ...
                                     <div className="col-lg-12 col-md-12">
                                        <div className="form-group">
                                            <label>By submitting the form you accept <Link href='/terms-and-conditions/'><a>Terms & Conditions</a></Link> and </label>
