            ...
            <div className="col-lg-12 col-md-12">
                <div className="privacy-policy-content">
                    <blockquote className="blockquote">
                        ...
                        on projects that are not successful. You are eligible to claim tax relief if your project meets
                        the eligibility criteria as defined by HMRC.
                    ...
                    <p>
                        Projects that work in the area of science and technology making an innovative advancement
                    ...
                    <p>Your project must target to innovate in the field that it is related to and not just only benefit
                        your business. This means an advance cannot just be an existing technology that has been used
                        for the first time in your sector. The product, service or process will still be considered an
                        innovation even if it is created by some other company and is not popular.</p>


                    <h2>Convince that a professional in the field could not work this out</h2>

                    <p>You need to convince why an existing professional in the field could not work out the innovation
                        proposed in your project. Explain why a professional could not easily work out your innovative
                        proposal. Prove by showing that other attempts to find a solution failed.</p>

                    <p>Demonstrate that the people in your project are professionals of the field and explain the
                        uncertainties affecting the results.</p>



                    <h2>Show there was uncertainty</h2>
                    <p>Show uncertainty in the field since it only exists when a subject matter expert can not conflict
                        with the technical possibilities of proposed innovation.</p>

                    <p>A scientific or technological uncertainty exists when an expert on the subject cannot say if
                        something is technologically possible or how it can be done after referring to all available
                        evidence.</p>

                    <p>Explain how you tried to overcome the uncertainty in your project as you need to show the R&D
                        project needed to go through the phases of research, analysis or testing to develop it.</p>

                    <p>Explain the strategies you took that helped you overcome the uncertainties in your project. You
                        can simply explain the success and failure of your project.</p>
