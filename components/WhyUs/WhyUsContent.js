                        ...
                        <div className="about-content">
                            <div className="content">
                                <ul className="about-list mb-0">
                                    ...
                                    <p>
                                    <ul>
                                        o Fees from £300 with a ceiling of £1200 for claims under £100,000. Anything
                                        claim above
                        ...
                        <div className="about-content">
                            <div className="content">
                                <ul className="about-list mb-0">
                                    ...
                                    <p>
                                    <ul>
                                        o We offer a complete online service from start to finish to minimise your time
                                        on the claim and
                                    ...
                                    <p>
                                    <ul>
                                        o We give you an estimated figure at the start of your claim in order for you
                                        make a decision on
                                        proceeding with a claim and a detailed calculation at the end of the claim
                                        process.
                                    </ul>
                                    </p>
                                    <li>
                                        <i className="flaticon-tick"></i>
                                        Assist Accountants and Businesses
                                    </li>
                                    <p>
                                    <ul>
                                        o We can provide the most innovative and cost-effective online tool to assist
                                        Accountants and
                                        Businesses through the web of the R&D Tax Credits process
                                    </ul>
                                    </p>
                                </ul>
                            </div>
